...
public class GradeConfiguration : IEntityTypeConfiguration<Grade>
{
    public void Configure(EntityTypeBuilder<Grade> builder)
    {
        ...
        // IsDeleted kolonu için veritabanı varsayılanına güvenmek yerine,
        // uygulama tarafında her zaman açıkça değer göndereceğiz.
        // Bu sayede NULL insert hatalarının önüne geçeriz.
