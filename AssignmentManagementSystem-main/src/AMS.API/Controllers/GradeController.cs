...
namespace AMS.API.Controllers
{
    ...
    public class GradeController : BaseController
    {
        ...
        /// </summary>
        [Authorize(Roles = "Instructor,Admin")]
        [HttpPost("auto-grade-late/{assignmentId}")]
        public async Task<IActionResult> AutoGradeLate(int assignmentId)
        {
            var instructorId = GetCurrentUserId();
            var result = await _gradeService.AutoGradeLateAssignmentsAsync(assignmentId, instructorId);
